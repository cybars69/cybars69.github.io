---
title: "Nonslop Sidebar"
blurb: "A UX-first sidebar navigation skill for AI coding agents. Accessible, responsive, and actually usable."
era: recent
order: 2
image: /images/projects/nonslop-sidebar-after.png
alt: "A redesigned sidebar with task-based groups, disclosure controls and a clear active destination"
tags: [Agent Skills, UX, Accessibility]
github: https://github.com/cybars69/nonslop-sidebar
kind: "Open source"
featured: true
readme: true
---

<!-- Synced verbatim from cybars69/nonslop-sidebar/README.md by scripts/sync-skill-readmes.mjs. Edit the README, then run `npm run sync:skills`. -->
...
<table align="center">
  ...
  <tr>
    <td align="center" valign="top">
      <img src="/images/skills/nonslop-sidebar/sidebar-before.png" alt="Before sidebar UX redesign showing a flat navigation hierarchy beside the WLLMS product workspace" width="100%" />
    </td>
    <td align="center" valign="top">
      <img src="/images/skills/nonslop-sidebar/sidebar-after.png" alt="After sidebar UX redesign showing task-based groups, disclosure controls, and a clear active destination in WLLMS" width="100%" />
    </td>
  </tr>
  <tr>
    <td valign="top">
