...
blurb: "A stays marketplace for a remote valley in Kashmir: search, booking, payments, payouts, and separate customer, merchant and admin apps."
era: recent
order: 5
image: /images/projects/hospitality-marketplace.png
alt: "Diagram: search, quote, pay, booking, payout, with merchant PWA, inventory, calendar sync and admin"
...
- [iCal is not a channel manager](/blog/ical-is-not-a-channel-manager/)
