---
title: "Dropping the agent framework"
description: "Rebuilding a multi-tenant WhatsApp chatbot with a cheap classifier, a plain router and raw API calls instead of an agent framework."
date: 2026-09-24
