# Streaming microphone audio from a browser, in three attempts

WebM chunks, WAV, decoded PCM and finally an AudioWorklet. What broke, why, and what the two failed write-ups got wrong.

Source: https://cybars69.github.io/blog/streaming-mic-audio-three-attempts/
