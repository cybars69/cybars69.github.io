# Modelling quizzes: question types, manual grading and the attempt state you didn't know you needed

What I learned by reading the source of a mature open-source LMS plugin before designing a quiz schema.

Source: https://cybars69.github.io/blog/modelling-quizzes-question-types-and-attempt-states/
