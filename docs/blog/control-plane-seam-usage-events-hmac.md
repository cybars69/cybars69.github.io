# The control-plane seam: idempotent usage snapshots, an event outbox and HMAC commands

How a per-tenant Worker and a central control plane talk to each other safely over unreliable networks, with no queue infrastructure.

Source: https://cybars69.github.io/blog/control-plane-seam-usage-events-hmac/
