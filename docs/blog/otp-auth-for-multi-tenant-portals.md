# OTP login, refresh-token families and three layers of access for multi-tenant portals

One identity system for patients, clinic staff, distributors and admins: challenge-based OTP in Redis, rotating refresh tokens, and access that is checked in three separate layers.

Source: https://cybars69.github.io/blog/otp-auth-for-multi-tenant-portals/
