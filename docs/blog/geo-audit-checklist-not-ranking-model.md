# A GEO audit is a checklist, not a ranking model

What an audit of a young marketing site found, and why fixing every point on the checklist still wouldn't have moved it off page six.

Source: https://cybars69.github.io/blog/geo-audit-checklist-not-ranking-model/
...
If you care about the other half of this problem, whether a page can be *extracted as an answer* rather than cited as a source, that is what [aeo-skills](https://cybars69.github.io/projects/aeo-skills/) measures. It is a different question from the one a GEO audit asks.
